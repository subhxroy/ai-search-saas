...
import { Sparkles, Eye, EyeOff, Mail, Lock, Github } from 'lucide-react'
...
/* ------------------------------------------------------------------ */
/*  Floating gradient orbs (shared background)                         */
/* ------------------------------------------------------------------ */
function FloatingOrbs() {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      />
      <div
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[36rem] h-[36rem] rounded-full animate-float-3"
        style={{
          background:
